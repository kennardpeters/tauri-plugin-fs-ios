...
pub fn init<R: Runtime>() -> TauriPlugin<R> {
  Builder::new("fs-ios")
    .invoke_handler(tauri::generate_handler![commands::ping, commands::create_file, commands::read_file, commands::write_file, commands::append_to_file, commands::delete_file, commands::create_dir, commands::list_dir, commands::delete_dir, commands::rename_dir, commands::current_dir])
    .setup(|app, api| {
      #[cfg(mobile)]
